...
int main(void){
    ...
    string addActor1 = "../actors_1.txt";
    string addActor2 = "../actors_2.txt";
    string addActor3 = "../actors_3.txt";
    string addActor4 = "../actors_4.txt";
    string addActor5 = "../actors_5.txt";
    string addActor6 = "../actors_6.txt";
    string addActor7 = "../actors_7.txt";
    string addActresses1 = "../actresses_1.txt";
    string addActresses2 = "../actresses_2.txt";
    string addActresses3 = "../actresses_3.txt";
    string addActresses4 = "../actresses_4.txt";
    string addActresses5 = "../actresses_5.txt";
    string addActresses6 = "../actresses_6.txt";
    string addActresses7 = "../actresses_7.txt";
    string addActresses8 = "../actresses_8.txt";
    
    //string addNameList = "NameList.txt";
    //string addNameList = "NameListTestOne.txt";
    //string addNameList = "NameList100.txt";
    string addNameList = "../nameProcessActor/NameListFinal2_1.txt";
