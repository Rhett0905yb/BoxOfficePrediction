...
int main(void){
    ...
    string addDirector1 = "../matchHowMuch/directors_1.txt";
    string addDirector2 = "../matchHowMuch/directors_2.txt";
    string addDirector3 = "../matchHowMuch/directors_3.txt";
    string addDirector4 = "../matchHowMuch/directors_4.txt";
    string addDirector5 = "../matchHowMuch/directors_5.txt";
    string addDirector6 = "../matchHowMuch/directors_6.txt";
    
    //string addNameList = "NameList.txt";
    //string addNameList = "NameListTestOne.txt";
    //string addNameList = "NameList100.txt";
    string addNameList = "DirectorListFinal2_4.txt";
